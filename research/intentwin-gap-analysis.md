...
## 1. WHERE INTENTWIN WINS (Strengths)
...
| Layer | What It Does | Competitor Equivalent |
|-------|-------------|----------------------|
| L1: Brand Voice | Enforces tone, terminology across all sections | Some tools have basic voice settings |
| L2: Section Best Practices | Proven templates per section type | Generic templates |
| L3: Persuasion Frameworks | AIDA, PAS, STAR, FAB auto-matched per section | None |
| L4: Win Themes | Differentiators woven throughout | Inventive AI has "Win Themes Engine" |
...
| **Claim verification:** Each claim tracked with evidence source and verification status | No competitor tracks claim provenance at this level |

**Verdict:** The verification + audit trail layer goes beyond what any competitor offers. This aligns with the trend that "AI is only as smart as the information you give it."
...
5 formats (DOCX, PPTX, PDF, HTML, Google Slides) with Mermaid diagram rendering. Most competitors offer 1-2 formats. Only PandaDoc and Proposify come close, but they lack AI-generated diagrams.

### 1.6 Version Control

7 trigger events with full snapshots, diff comparison, and one-click restore. Enterprise-grade versioning that most competitors lack entirely.

---

## 2. WHERE INTENTWIN FALLS SHORT (Weaknesses)
...
| Pipeline sync | None | Bi-directional proposal status ↔ CRM pipeline |
| Auto-populate from CRM | None | Pull client name, industry, contacts automatically |

**Impact:** 73% of enterprise buyers require CRM integration. This is a **deal-killer** for enterprise sales. Salesforce AppExchange listing is also a major distribution channel competitors use.
...
| Encryption certification | Using Supabase defaults | AES-256 explicitly stated by competitors |
| GDPR/HIPAA alignment | Not documented | Required for regulated industries |

**Impact:** Audit failures delay deals by 6-12 months. Without SOC 2, enterprise pipeline will stall. Multiple competitors (1up, QorusDocs, Responsive) lead with security positioning.
...
| Approval workflows | Basic | Responsive, Loopio have multi-stage approval routing |
| Comment/review system | Annotations exist | Needs deeper threading and resolution tracking |

**Impact:** Cross-departmental collaboration is a top buyer expectation. Proposal teams (sales, legal, SMEs, pricing) need to work concurrently.
...
| Go/no-go criteria | None | Standard in enterprise tools |

### 2.6 Single Pricing Tier ($999/mo)

| Issue | Detail |
|-------|--------|
| No entry-level plan | Competitors start at $19-75/user/mo; shuts out SMBs |
| No free trial / freemium | PandaDoc's free tier drove them to $100M ARR |
...
## 3. WHAT'S MISSING ENTIRELY (Gaps)
...
No multi-language support. Loopio (Advanced+), Responsive, AutoRFP.ai, and Thalamus all offer translation. Critical for global enterprises.
...
- **Competitive win/loss by competitor name**
- **Revenue pipeline tied to proposals**

### 3.4 API / Embedding Capabilities

No public API. Enterprise buyers expect:
- API access for custom integrations
- Webhook notifications
- Embeddable proposal components
- SSO beyond basic auth

### 3.5 Mobile Access

No mobile app or responsive dashboard for review on-the-go. QorusDocs offers iOS/Android apps.
...
```
     ...
     (Quality Council +    |        * Inventive AI
      Intent Framework)    |     (Win Themes Engine)
                           |
                           |  * Thalamus AI
       * AutogenAI         |  (20+ AI Agents)
     (Grant Writing)       |
                           |
    -----------------------+-------------------------> Enterprise Readiness
                           |
        * DeepRFP          |     * Responsive
        * Bidara           |     (40+ integrations, $94M rev)
                           |
                           |     * Loopio
                           |     (9.7/10 support, 1700+ cos)
                           |
    * PandaDoc             |     * QorusDocs
    (56K customers, PLG)   |     (Microsoft native)
                           |
```
...
### Tier 1: Fix the Deal-Killers (Next 30 days)

| Priority | Action | Rationale |
|----------|--------|-----------|
| **P0** | Salesforce integration (read-only to start) | 73% enterprise requirement; distribution channel via AppExchange |
| **P0** | Publish security/data handling page | "Your data never trains AI models" + encryption details |
| **P0** | Add a free trial or starter tier | Currently invisible to market; need top-of-funnel |

### Tier 2: Close Competitive Gaps (60-90 days)

| Priority | Action | Rationale |
|----------|--------|-----------|
| **P1** | Content library with reusable blocks | Industry consensus: preservation > generation |
| **P1** | Real-time collaboration (at least concurrent editing) | Cross-department collaboration is a top expectation |
| **P1** | Visual compliance matrix for RFP requirements | Growing use case (7% → 12%), aligns with existing req extraction |
| **P1** | Multi-tier pricing (Starter/Pro/Enterprise) | Capture SMB entry + enterprise upsell |

### Tier 3: Build the Moat Deeper (90-180 days)

| Priority | Action | Rationale |
|----------|--------|-----------|
| **P2** | SOC 2 Type II certification | 6-12 month process; start now |
| **P2** | Bid/no-bid scoring engine | No competitor does this well with AI |
| **P2** | Continuous learning from win/loss outcomes | Make the Quality Council smarter over time |
| **P2** | Public API + webhooks | Enterprise integration requirement |
| **P2** | Translation support | Global enterprise requirement |
...
Pro:        $999/mo     — 10 users, unlimited proposals, full council review
Enterprise: $2,499/mo   — unlimited users, API access, SSO, dedicated support
Free Trial: 14 days     — full Pro features, 2 proposals
```

**Why:** This captures the mid-market sweet spot ($500-$2,000/mo) that research identified as underserved. The hybrid of platform fee + proposal limits creates natural expansion revenue.

---

## 6. KEY MARKET NUMBERS

| Metric | Value |
|--------|-------|
| Market size (2025) | $3.2-3.6B |
| Market size (2031) | $7.0-7.35B |
| CAGR | 11-14% |
| AI adoption by proposal teams | 68% (doubled in 1 year) |
| Average RFP win rate | 45% |
| Time savings with AI tools | 30-40% reduction |
| Enterprise budget allocation to AI | 5% of annual budget |
| SOC 2 requirement for enterprise | 73% of buyers |
| Teams using RFP software | 65% (up from 48%) |
...
| File | Contents |
|------|----------|
| `research/ai-proposal-generation-landscape.md` | Industry trends, market size, best practices, buyer expectations |
| `research/competitive-analysis.md` | 24 platform profiles, pricing matrix, funding tracker |
| `research/business-models-gtm-strategies.md` | Pricing models, GTM strategies, revenue benchmarks, case studies |
| `research/intentwin-gap-analysis.md` | This file — synthesis and strategic recommendations |
