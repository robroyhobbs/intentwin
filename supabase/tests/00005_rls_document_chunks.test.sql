...
INSERT INTO public.documents (id, title, file_name, file_type, file_size_bytes, storage_path, mime_type, processing_status, uploaded_by, organization_id, created_at, updated_at)
VALUES
  ('f0000000-0000-0000-0000-000000000003'::uuid, 'Orphan Doc', 'orphan.pdf', 'pdf', 512, '/orphan.pdf', 'application/pdf', 'completed', 'u0000000-0000-0000-0000-000000000001'::uuid, NULL, now(), now());
