...
export function buildTeamPrompt(
  ...
  return `Write the "Proposed Team & Qualifications" section for a Capgemini proposal.
...
3. Highlights Capgemini's relevant certifications (AWS, Azure, GCP partnerships)
4. Mentions the depth of Capgemini's talent pool
