...
export function buildExecutiveSummaryPrompt(
  ...
  return `Write an executive summary for a Capgemini proposal based on the following information.
...
3. Summarizes Capgemini's proposed approach at a high level
