...
export function buildApproachPrompt(
  ...
  return `Write the "Proposed Approach" section for a Capgemini proposal.
...
1. Describes the phased approach Capgemini will take
...
7. Shows how Capgemini's methodology addresses the client's specific needs
