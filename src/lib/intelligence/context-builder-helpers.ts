...
export function buildAgencySectionLines(agency: AgencyProfileResponse): string[] {
  const lines: string[] = [];
...
export function buildPricingSectionLines(pricing: PricingLookupResponse): string[] {
...
export function buildPricingBenchmarkMap(pricing: PricingLookupResponse): Map<string, (typeof pricing.rate_benchmarks)[0]> {
