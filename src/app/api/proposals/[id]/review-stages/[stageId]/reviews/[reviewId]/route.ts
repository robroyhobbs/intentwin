...
import { withProposalRoute, notFound, badRequest, forbidden, ok, serverError } from "@/lib/api/response";

/**
 * PATCH /api/proposals/[id]/review-stages/[stageId]/reviews/[reviewId]
 * Update an existing section review
 */
export const PATCH = withProposalRoute(async (request, { id, stageId, reviewId }, context) => {
