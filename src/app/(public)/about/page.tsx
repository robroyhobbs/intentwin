      ...
      <section className="relative bg-gradient-to-br from-[#1B365D] via-[#0070AD] to-[#12ABDB] text-white overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-24 md:py-32">
          <div className="text-center animate-hero">
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6">IntentWin</h1>
            <p className="text-xl md:text-2xl text-cyan-100 mb-4 max-w-3xl mx-auto">
              Intelligent Proposal Generation
            </p>
            <p className="text-lg text-white/80 mb-10 max-w-2xl mx-auto">
              Transforming how your team wins business by leveraging our
              collective intelligence to create winning proposals in hours, not
              weeks.
            </p>
            ...
            {[
              {
                icon: Clock,
                label: "TIME",
                text: "Proposals take weeks to complete, missing opportunities",
              },
              {
                icon: BarChart3,
                label: "QUALITY",
                text: "Inconsistent output quality across teams and regions",
              },
              {
                icon: GitBranch,
                label: "KNOWLEDGE",
                text: "Best practices and case studies scattered across silos",
              },
              {
                icon: Users,
                label: "RESOURCES",
                text: "Senior experts bottlenecked on repetitive writing tasks",
              },
              {
                icon: FileText,
                label: "REUSE",
                text: "Winning strategies rarely captured or replicated",
              },
              {
                icon: TrendingUp,
                label: "SCALE",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-slideInLeft">
              ...
              <p className="text-lg text-gray-600 mb-6">
                IntentWin is an intelligent platform that leverages your
                team&apos;s collective knowledge to generate winning proposals
                in hours, not weeks.
              </p>
              <p className="text-gray-600 mb-8">
                It combines our methodologies, case studies, and institutional
                expertise with advanced AI to create consistent, high-quality
                proposals at scale.
              </p>
              ...
              {[
                {
                  ...
                  desc: "Built-in industry methodologies, frameworks, and best practices",
                },
                {
                  icon: Shield,
                  title: "Verified Content",
                  desc: "Real case studies with verified metrics and outcomes",
                },
                {
                  icon: Target,
                  title: "Intent-Driven",
                  desc: "Every proposal aligned to client outcomes and win strategy",
                },
                {
                  icon: Users,
                  title: "Human Quality",
                  desc: "AI generates, humans review and refine",
                },
              ].map((item) => (
                <div
                  key={item.title}
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-[#1B365D] mb-1">
                        {item.title}
                      </h3>
            ...
            {[
              {
                layer: "L1",
                title: "Company Truth",
                desc: "Verified capabilities, certifications, case studies, and methodologies. The canonical source of what we can claim.",
                color: "from-[#1B365D] to-[#2A4A72]",
              },
              {
                layer: "L2",
                title: "Proposal Intent",
                desc: "Client outcomes, win strategy, constraints, and success metrics. Human-defined goals that guide generation.",
                color: "from-[#0070AD] to-[#0088CC]",
              },
              {
                layer: "L3",
                title: "Generated Content",
                desc: "AI-created proposal sections, reviewed and refined by humans. Every claim traceable to L1 sources.",
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {[
              {
                title: "Embedded Methodologies",
                desc: "Built-in CCMF, ADMnext, and eAPM frameworks ensure consistent, proven approaches",
              },
              {
                title: "Verified Case Studies",
                desc: "Real examples with metrics: BMW 5,200+ apps, HMRC £245M contract, aerospace migrations",
              },
              {
                title: "Intent-First Approach",
                desc: "Start with client outcomes and win strategy - every section aligned to what matters most",
              },
              {
                title: "Human-in-the-Loop",
                desc: "AI accelerates, humans validate. Quality control at every stage of the process",
              },
              {
                title: "Full Lifecycle",
                desc: "Not just generation - review, collaboration, versioning, and multi-format export",
              },
              {
          ...
          <p className="text-center text-gray-600 italic">
            This isn&apos;t generic AI - it&apos;s your team&apos;s
        ...
        <div className="max-w-6xl mx-auto px-6">
            ...
            {[
              {
                num: "1",
                title: "Define",
                desc: "Enter client details, industry, and opportunity type",
              },
              {
                num: "2",
                title: "Outcomes",
                desc: "Set desired outcomes, win strategy, and constraints",
              },
              {
                num: "3",
                title: "Generate",
                desc: "AI creates sections using company context",
              },
              {
                num: "4",
                title: "Review",
                desc: "Refine content, collaborate with team",
              },
              {
                num: "5",
                title: "Export",
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gray-50 rounded-xl p-6 text-center">
              <p className="text-sm font-bold text-[#0070AD] mb-2">
                EXPORT FORMATS
              </p>
            ...
            <div className="bg-gray-50 rounded-xl p-6 text-center">
              ...
              <p className="text-gray-700 text-sm">
                Executive Summary, Approach, Methodology, Team, Case Studies,
                Timeline, Pricing, Risk, Why Us
              </p>
            </div>
          </div>
        </div>
            ...
            {[
              {
                ...
                desc: "From weeks to hours",
                highlight: true,
              },
              {
                metric: "15-25%",
                label: "Win Rate Potential",
                desc: "Better targeting & quality",
                highlight: false,
              },
              {
                metric: "100%",
              ...
              },
              {
                ...
                desc: "Same team capacity",
                highlight: false,
              },
              {
                metric: "1",
                label: "Knowledge Source",
                desc: "Unified expertise",
                highlight: false,
              },
            ].map((item, i) => (
              <div
              ...
              >
                ...
                <p className="font-semibold text-[#1B365D] mb-1">
                  {item.label}
                </p>
                <p className="text-gray-600 text-sm">{item.desc}</p>
              </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              <h3 className="text-xl font-semibold text-[#0070AD] mb-6">
                Core Capabilities
              </h3>
            ...
            <div className="bg-gradient-to-br from-[#1B365D] to-[#2A4A72] rounded-2xl p-8 text-white animate-slideInRight">
              ...
              <div className="space-y-4">
                {[
                  {
                    title: "Warm, Human Design",
                    desc: "Clean, approachable interface that guides users through the process",
                  },
                  {
                    title: "Real-Time Generation",
                    desc: "Watch AI create content with live progress updates",
                  },
                  {
                    title: "Inline Editing",
                    desc: "Edit, refine, and perfect content directly in the interface",
                  },
                  {
                    title: "Source Transparency",
                    desc: "See exactly which company sources informed each section",
                  },
                ].map((item) => (
                  <div key={item.title} className="bg-white/10 rounded-lg p-4">
                    <h4 className="font-semibold text-[#12ABDB] mb-1">
                      {item.title}
                    </h4>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="animate-fadeInUp">
            ...
            <p className="text-xl text-cyan-100 mb-10">
              Join the pilot program and experience the future of proposal
              generation
            </p>
              ...
              {[
                {
                  num: "1",
                  title: "Pilot Program",
                  desc: "Select teams to test with real opportunities",
                },
                {
                  num: "2",
                  title: "Training",
                  desc: "Onboard users and configure knowledge base",
                },
                {
                  num: "3",
                  title: "Rollout",
                  desc: "Scale to broader organization",
                },
              ].map((step) => (
                <div
                  key={step.num}
                  className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border-t-2 border-[#12ABDB]"
                >
                  <p className="text-2xl font-bold text-[#12ABDB] mb-2">
                    {step.num}
                  </p>
