...
// NOTE: generateProposal tests were removed because generate.ts was deleted.
// Full generation is now covered by Inngest function tests in
// src/inngest/__tests__/generate-proposal.test.ts
